...
export const ActivatedHomeIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="ActivatedHome"
        className={className}
        height={height}
...
export const ActivatedSearchIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Search"
        className={className}
        height={height}
...
export const ActivatedMessagesIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Direct"
        className={className}
        color="#262626"
...
export const ActivatedNotificationsIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Notifications"
        className={className}
        height={height}
...
export const ActivatedProfileIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Logo = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
